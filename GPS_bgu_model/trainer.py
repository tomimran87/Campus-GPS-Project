...
class Trainer:
    ...
    """
    def __init__(self, model, train_loader, val_loader, loss_fn, device, lr=0.0001):
    ...
    def fit(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            for images, labels in pbar:
                ...
                if torch.isnan(loss) or torch.isinf(loss):
                    ...
                    if nan_batches <= 3:  # Only print first few warnings
                        print(f"\n⚠️  Warning: NaN/Inf loss detected in epoch {epoch+1}, skipping batch")
                    continue
            ...
            if nan_batches > 0:
                print(f"⚠️  Epoch {epoch+1}: {nan_batches} batches skipped due to NaN/Inf")

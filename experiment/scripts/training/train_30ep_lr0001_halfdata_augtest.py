#!/usr/bin/env python3
"""
Experiment: 30 Epochs, LR=0.0001, Half Data Training with Augmented Test Set
=============================================================================
...
OUTPUT:
    testing/30ep_lr0001_halfdata_augtest/
    ├── ResNet18/
    ├── EfficientNet/
    ├── ConvNeXt/
    ├── comparison/
...
CONFIG = {
    ...
    "OUTPUT_DIR": Path("testing/30ep_lr0001_halfdata_augtest"),
}

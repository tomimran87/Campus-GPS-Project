#!/usr/bin/env python3
"""
Experiment: 100 Epochs, LR=0.0001, Half Data Training with Augmented Test Set
==============================================================================
...
OUTPUT:
    testing/100ep_lr0001_halfdata_augtest/
"""
...
CONFIG = {
    ...
    "OUTPUT_DIR": Path("testing/100ep_lr0001_halfdata_augtest"),
}
...
def train_model(model_name, model_class, train_loader, val_loader, test_loader, min_val, max_val):
    ...
    model_path = output_dir / f"{model_name}_100ep_augtest.pth"
    ...
    print(f"\n📊 {model_name} Results (Augmented Test):")
...
def main():
    print("=" * 70)
    print("EXPERIMENT: 100 Epochs, LR=0.0001, Half Data + Augmented Test")
    print("=" * 70)
    ...
    # Summary
    print("\n" + "=" * 70)
    print("FINAL SUMMARY (Augmented Test Set)")
    print("=" * 70)
    ...
    with open(CONFIG["OUTPUT_DIR"] / "experiment_summary.json", 'w') as f:
        json.dump({
            'experiment': '100ep_lr0001_halfdata_augtest',
            'config': {
                'epochs': CONFIG['EPOCHS'],
